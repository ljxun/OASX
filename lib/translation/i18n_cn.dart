...
final Map<String, String> _cn_ui = {
  ...
  I18n.network_server_error: 'YYS内部服务异常',
  I18n.scheduler: '调度器',
  I18n.running: '运行中',
  I18n.pending: '队列中',
  I18n.waiting: '等待中',
  ...
  I18n.kill_oas_server: '结束YYS服务',
  I18n.are_you_sure_kill: '真的要关闭脚本服务吗',
  I18n.kill_server_success: '关闭服务成功',
  I18n.kill_server_failure: '关闭服务失败',
  I18n.kill_server_failure_msg: '请检查YYS服务是否已经关闭,然后手动登出',
  I18n.find_oas_new_version: '发现YYS新版本',
  I18n.oas_latest_version: 'YYS已是最新版本',
  ...
  I18n.root_path_server: 'YYS根目录',
  I18n.select_root_path_server: '选择文件夹',
  I18n.root_path_server_help:
  'YYS.EXE跟YYS_VIEW.EXE是两个不同的东西, 不要搞混，不要放在同一个目录下, 不要有空格的, 不要有中文的, 也不要路径过长的',
  I18n.root_path_correct: '正确识别为YYS的根目录',
  I18n.root_path_incorrect: '无法识别的根目录，你可能没有正确安装YYS',
  I18n.install_oas_now: '现在安装YYS',
  I18n.install_oas_success: '安装YYS成功',
  I18n.install_oas_failure: '安装YYS失败',
  I18n.install_oas_from_github: '从GitHub安装YYS',
...
final Map<String, String> _cn_menu = {
  ...
  I18n.switch_account: '账号切换',
  I18n.switch_account_config: '配置',
  I18n.switch_account_once: '单次切换',
  I18n.switch_account_loop: '循环切换',
  I18n.nian_true: '现世年兽',
};
