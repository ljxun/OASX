...
final Map<String, String> _cn_ui = {
  ...
  I18n.network_server_error: '内部服务异常',
  I18n.scheduler: '调度器',
  I18n.running: '运行中',
  I18n.pending: '队列中',
  I18n.waiting: '等待中',
  ...
  I18n.kill_oas_server: '结束服务',
  I18n.are_you_sure_kill: '真的要关闭脚本服务吗',
  I18n.kill_server_success: '关闭服务成功',
  I18n.kill_server_failure: '关闭服务失败',
  I18n.kill_server_failure_msg: '请检查服务是否已经关闭,然后手动登出',
  I18n.find_oas_new_version: '发现新版本',
  I18n.oas_latest_version: '已是最新版本',
  ...
  I18n.root_path_server: '根目录',
  I18n.select_root_path_server: '选择文件夹',
  I18n.root_path_server_help:
  '路径不要有空格, 不要有中文, 也不要路径过长',
  I18n.root_path_correct: '正确识别根目录',
  I18n.root_path_incorrect: '无法识别的根目录，你可能没有正确安装',
  I18n.install_oas_now: '现在安装',
  I18n.install_oas_success: '安装成功',
  I18n.install_oas_failure: '安装失败',
  I18n.install_oas_from_github: '从Gitee安装',
  I18n.install_oas_help: '这将会从Gitee上下载并解压，请保持网络稳定，同时将会清空该目录',
